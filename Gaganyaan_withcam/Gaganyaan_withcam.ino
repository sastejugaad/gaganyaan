//https://rntlab.com/question/esp32-cam-project-without-deep-sleep-mode-with-pir-sensor/   --- solve intrrupt issue
...
const char * networkName = "vr";//Askey5100-02B0
const char * networkPswd = "12345678";//HHLUnKLKQW

//IP address to send UDP data to:
// either use the ip address of the server or 
// a network broadcast address
const char * udpAddress = "192.168.4.2"; //Ip address of YOUR pc
...
void enableInterrupt(){
  esp_err_t err = gpio_isr_handler_add(GPIO_NUM_2, &dmpDataReady, (void *) 1);
  if (err != ESP_OK) {
